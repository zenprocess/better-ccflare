 ...
 * cancel a body that the proxy is actively forwarding to the client.
 *
 * This is the bug class this repo's `fix/silent-stream-truncation`
 * branch was created to address: cancelling a body stream that is still
 ...
 * verify that (a) the body is fully consumed end-to-end (i.e. cancel was
 * not called somewhere it shouldn't be), and (b) cancelling a
